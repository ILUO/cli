...
| [`+subscribe-event`](references/lark-task-subscribe-event.md) | manually create the task-event subscription; prefer `event consume task.task.update_user_access_v2` for listening |
